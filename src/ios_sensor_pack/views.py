...
from .serializers import (
    GravitySerializer, UserAccellerationSerializer, AttitudeSerializer, MagneticFieldSerializer, LocationSerializer,
    IosSensorSerializer
)
...
class IosSensorViewSet(viewsets.ModelViewSet):
    serializer_class = IosSensorSerializer
    model = IosSensor
    permission_classes = [IsAuthenticated, ]
    filterset_fields = ['user', 'created']
