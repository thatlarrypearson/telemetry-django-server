"""
Django settings for Telemetry Django Server project.
...
ALLOWED_HOSTS = ['127.0.0.1', '192.168.1.51',]
...
ROOT_URLCONF = 'telemetry_django_server.urls'
...
WSGI_APPLICATION = 'telemetry_django_server.wsgi.application'
